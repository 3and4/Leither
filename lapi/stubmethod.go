...
// 接口验证
var _ IAuth = (*LApiStub)(nil)
var _ IVarAct = (*LApiStub)(nil)
var _ IMiMei = (*LApiStub)(nil)
var _ INet = (*LApiStub)(nil)
...
// FilesCheck 检查指定路径中的文件哪些不在本地
func (stub *LApiStub) FilesCheck(sid, ps string, sync bool) error {
	if stub.NetStub.FilesStub.FilesCheck == nil {
		return nil
	}
	return stub.NetStub.FilesStub.FilesCheck(sid, ps, sync)
}
