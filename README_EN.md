Leither
========
Leither is an ultra-lightweight decentralized cloud operating system designed to dismantle and reconstruct traditional internet services in a decentralized manner.

Users can build or join a decentralized network, where they can access or publish application services and information. In this network, the generation, storage, publication, display, and dissemination of information (including applications) are entirely decentralized. The rules for each step are transparent, and users can build their own, with no irreplaceable part. The network is characterized by being user-built, user-controlled, and user-owned.

Inspired by genes and memes, a "mimei" is the smallest unit of information, capable of storing data and applications. Mimeis support file systems and databases, allowing information to flow between different nodes in the form of mimeis. Mimeis can express complex business forms through associations similar to links.

Through mimeis and the application system, developers can dismantle internet platform businesses in a decentralized way. The system can achieve common internet applications with minimal resources, including but not limited to websites, public accounts, mini-programs, and apps. It is only 17 megabytes in size and can run on various devices such as PCs, servers, phones, NAS, routers, and Raspberry Pi. A single node can be used as a lightweight host, achieving IDC host effects on a home network at almost zero cost. Two nodes can cooperate for data backup, fault tolerance, load balancing, domain name resolution, and routing. Multiple nodes can build a decentralized distributed network, implementing common internet applications in a decentralized manner.

The system can run on common base operating systems, including but not limited to Windows, Linux, FreeBSD, Darwin, and Android. It implements authentication systems, application systems, file and database systems, domain name, and network systems. Developers can develop applications through APIs, which support over forty common languages. Developers can also interact with the system via command line or browser.

### **Installation and Operation**
Application changes and programs are available at the following URL:
<a href="./bin/README.md"> Download applications of various versions</a>
