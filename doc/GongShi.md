...
**网络心跳**  
心跳是一个从上至下定期广播的递增数据序号，缺省心跳频率为每秒一次。
...
一个**选举周期**缺省为30分钟。每个周期内，网络都选出了可靠的各级节点**话事人**。相应的工作被分派给了各级节点。每一个节点都有备选人，保障了网络的健壮性。最底层节点负责处理详细的业务，上层节点只负责合并汇总分支中的变动信息，包括取摘要信息。
