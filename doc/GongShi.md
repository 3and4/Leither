...
**争议处理**  
每笔交易都需要有足够的保证金背书，足够的时间以供更多的节点进行审查。交易是同时多个节点处理，话事人和备份话事人都是随机分配的，避免串通的可能性。任何一个节点有异议，都会进入争议流程，争议期相关金额会被冻结。全网对出错交易进行验证，根据验证结果进行投票，出错节点的保证金会被没收。话事人只能处理冻结资金所支持的交易金额。  
...
**规模分析**
这些信息大部分会分布在一个32层的网络中，话事人进行分组，分别处理8，8，16层
